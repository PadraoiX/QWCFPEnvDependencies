...
@ManagedBean(name = "notiAllMyAreaBean")
@ViewScoped
public class NotifyAllMyAreaBean extends AbstractBean {
	...
	private void updateNotifiesArea(){
		...
		setNotifiesArea(notifyService.listarAllMyArea(dataInicio, dataFim));
	}
