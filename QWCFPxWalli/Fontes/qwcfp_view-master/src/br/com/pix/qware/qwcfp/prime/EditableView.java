...
public class EditableView implements Serializable {
	 ...
	 * 
	 */
	private static final long	serialVersionUID	= 8252979524296423597L;
    ...
    public DiagramModel getModel() {
        ...
        EndPoint endPointCAC = createDotEndPoint(EndPointAnchor.AUTO_DEFAULT);
        endPointCA.setSource(true);
        
        computerA.addEndPoint(endPointCA);
        computerA.addEndPoint(endPointCAC);
        ...
        EndPoint endPointCBC = createDotEndPoint(EndPointAnchor.AUTO_DEFAULT);
        endPointCB.setSource(true);
        computerB.addEndPoint(endPointCBC);
        ...
        EndPoint endPointCCC = createDotEndPoint(EndPointAnchor.AUTO_DEFAULT);
        endPointCC.setSource(true);
        computerC.addEndPoint(endPointCCC);
        ...
        EndPoint endPointButtonSA = createRectangleEndPoint(EndPointAnchor.BOTTOM);
        serverA.setDraggable(true);
        endPointSA.setTarget(true);
        serverA.addEndPoint(endPointButtonSA);
        ...
        EndPoint endPointButtonSB = createRectangleEndPoint(EndPointAnchor.BOTTOM);
        serverB.setDraggable(true);
        endPointSB.setTarget(true);
        serverB.addEndPoint(endPointButtonSB);
        ...
        model.connect(new Connection(computerC.getEndPoints().get(0), computerA.getEndPoints().get(0)));
